...
public class BranchDiffProc implements DiffProc<Branch> {
    ...
    class BranchDiffResult implements DiffResult {
        ...
        public BranchDiffResult(BranchDiffInfo branchInfo1, BranchDiffInfo branchInfo2, boolean isDifferent) {
    ...
    public DiffResult diff(Branch branch1, Branch branch2) {
        ...
        return new BranchDiffResult(branchInfo1, branchInfo2, !areEquals(branchInfo1, branchInfo2));
    }
    ...
    private boolean areEquals(BranchDiffInfo branchInfo1, BranchDiffInfo branchInfo2) {
        return areEquals(branchInfo1.getTerminalData(Side.ONE), branchInfo2.getTerminalData(Side.ONE))
               && areEquals(branchInfo1.getTerminalData(Side.TWO), branchInfo2.getTerminalData(Side.TWO));
    }
