...
public class TransformerConverter extends AbstractConverter {
    ...
    private void createTwoWindingsTransformer() {
        ...
        double nomV1 = psseTransformer.getWindingRecord1().getNomv();
        double nomV2 = psseTransformer.getWindingRecord2().getNomv();
        ...
        ComplexRatio w1 = defineComplexRatio(psseTransformer.getWindingRecord1().getWindv(), psseTransformer.getWindingRecord1().getAng(), baskv1, nomV1, psseTransformer.getCw());
        double w2 = defineRatio(psseTransformer.getWindingRecord2().getWindv(), baskv2, nomV2, psseTransformer.getCw());
        TapChanger tapChanger = defineTapChanger(w1, psseTransformer.getWindingRecord1(), baskv1, nomV1, psseTransformer.getCw());
    ...
    private void createThreeWindingsTransformer() {
        ...
        double nomV1 = psseTransformer.getWindingRecord1().getNomv();
        double nomV2 = psseTransformer.getWindingRecord2().getNomv();
        double nomV3 = psseTransformer.getWindingRecord3().getNomv();
        ...
        // Handling terminal ratios
        ComplexRatio w1 = defineComplexRatio(psseTransformer.getWindingRecord1().getWindv(), psseTransformer.getWindingRecord1().getAng(), baskv1, nomV1, psseTransformer.getCw());
        ComplexRatio w2 = defineComplexRatio(psseTransformer.getWindingRecord2().getWindv(), psseTransformer.getWindingRecord2().getAng(), baskv2, nomV2, psseTransformer.getCw());
        ComplexRatio w3 = defineComplexRatio(psseTransformer.getWindingRecord3().getWindv(), psseTransformer.getWindingRecord3().getAng(), baskv3, nomV3, psseTransformer.getCw());

        TapChanger tapChanger1 = defineTapChanger(w1, psseTransformer.getWindingRecord1(), baskv1, nomV1, psseTransformer.getCw());
        TapChanger tapChanger2 = defineTapChanger(w2, psseTransformer.getWindingRecord2(), baskv2, nomV2, psseTransformer.getCw());
        TapChanger tapChanger3 = defineTapChanger(w3, psseTransformer.getWindingRecord3(), baskv3, nomV3, psseTransformer.getCw());
    ...
    private static TapChanger defineTapChanger(ComplexRatio complexRatio, WindingRecord winding, double baskv,
        double nomv, int cw) {
    ...
    private void addControlTwoWindingsTransformer() {
        ...
        if (twt.hasRatioTapChanger()) {
            boolean regulating = defineVoltageControl(getNetwork(), twt.getId(), psseTransformer.getWindingRecord1(),
        ...
        if (twt.hasPhaseTapChanger()) {
            defineActivePowerControl(getNetwork(), twt.getId(), psseTransformer.getWindingRecord1(), twt.getPhaseTapChanger(), regulatingForcedToOff);
        }
    }
    ...
    private void addControlThreeWindingsTransformer() {
        ...
        boolean regulatingForcedToOff = false;
        regulatingForcedToOff = addControlThreeWindingsTransformerLeg(getNetwork(), twt.getId(), twt.getLeg1(), psseTransformer.getWindingRecord1(), regulatingForcedToOff);
        regulatingForcedToOff = addControlThreeWindingsTransformerLeg(getNetwork(), twt.getId(), twt.getLeg2(), psseTransformer.getWindingRecord2(), regulatingForcedToOff);
        addControlThreeWindingsTransformerLeg(getNetwork(), twt.getId(), twt.getLeg3(), psseTransformer.getWindingRecord3(), regulatingForcedToOff);
    }

    private static boolean addControlThreeWindingsTransformerLeg(Network network, String id, Leg leg,
        WindingRecord winding, boolean regulatingForcedToOffInput) {
    ...
    private static boolean defineVoltageControl(Network network, String id, WindingRecord winding, RatioTapChanger rtc,
    ...
    private static boolean defineActivePowerControl(Network network, String id, WindingRecord winding, PhaseTapChanger ptc, boolean regulatingForcedToOff) {
    ...
    private static Terminal defineRegulatingTerminal(Network network, String id, WindingRecord winding) {
